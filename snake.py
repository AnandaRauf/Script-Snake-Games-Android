"""
# Games Snakes Command Prompt
# 10 Mei 2018
# Code Phyton
# Name Program: snake.py
...
class Snake(Frame):
    ...
    def __init__(self):
        ...
        self.master.title("Games Snake Command Prompt")
        self.grid()
    ...
    def new_game(self):
        ...
        self.canvas.create_text(WIDTH/2,HEIGHT/2-50,text="Welcome To  Games Snake CMD!"\
                                + "\n klik Window or Klick Arrow Keyboard"
                                + "\n For To Playing Games", tag="welcome_text")
